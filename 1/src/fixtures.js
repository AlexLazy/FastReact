export const arr1 = { fruits: ["banana", "peach", "orange", "apple", "mango"] };
export const arr2 = {
  fruits: [
    {
      name: "banana",
      url:
        "https://www.eliquidukstore.com/wp-content/uploads/2014/03/banana-e-liquid-500x500@2x.jpeg"
    },
    {
      name: "mango",
      url:
        "https://www.eliquidukstore.com/wp-content/uploads/2015/03/mango-e-liquid-500x500@2x.jpg"
    },
    {
      name: "peach",
      url:
        "https://www.eliquidukstore.com/wp-content/uploads/2015/03/peach-e-liquid-500x500@2x.jpg"
    },
    {
      name: "orange",
      url:
        "https://images-na.ssl-images-amazon.com/images/I/714LOAKHnfL._SX522_.jpg"
    },
    {
      name: "apple",
      url:
        "https://www.eliquidukstore.com/wp-content/uploads/2014/03/apple-e-liquid-500x500@2x.jpg"
    }
  ]
};
export const arr3 = [
...
export const arr4 = [
  ...
  },
  {
    ...
    missions: [{ name: "CRS-6", flight: 22 }, { name: "CRS-13", flight: 51 }],
    landings: 2,
    type: "Dragon 1.1",
  ...
  },
  {
    ...
    missions: [{ name: "CRS-8", flight: 28 }, { name: "CRS-14", flight: 59 }],
    landings: 2,
    type: "Dragon 1.1",
    details: null,
    reuse_count: 1
  },
  {
    ...
    missions: [{ name: "CRS-9", flight: 32 }, { name: "CRS-15", flight: 64 }],
    landings: 2,
    type: "Dragon 1.1",
    details: null,
    reuse_count: 1
  },
  {
    ...
    missions: [{ name: "CRS-10", flight: 36 }, { name: "CRS-16", flight: 72 }],
    landings: 2,
    type: "Dragon 1.1",
    details: null,
    reuse_count: 1
  },
  {
    ...
    missions: [{ name: "CRS-12", flight: 45 }, { name: "CRS-17", flight: 78 }],
    landings: 2,
    type: "Dragon 1.1",
